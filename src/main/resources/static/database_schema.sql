...
CREATE TABLE `log` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK62d93bhduepxid64ro388yv9k` (`admin_id`),
  CONSTRAINT `FK62d93bhduepxid64ro388yv9k` FOREIGN KEY (`admin_id`) REFERENCES `admin` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `member` (
  `membership_level` int DEFAULT NULL,
...
-- Dump completed on 2023-03-05  0:38:53
